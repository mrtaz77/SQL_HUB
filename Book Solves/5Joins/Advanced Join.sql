...
SELECT
	E1.LAST_NAME,
	COUNT(DISTINCT E2.EMPLOYEE_ID ) AS TOTAL_EMPLOYEES_HIRED_BEFORE,
	COUNT(DISTINCT E3.EMPLOYEE_ID ) AS TOTAL_EMPLOYEES_HIRED_AFTER
FROM
	EMPLOYEES E1
...
SELECT E1.EMPLOYEE_ID,COUNT(DISTINCT E2.EMPLOYEE_ID) NUM
...
FROM EMPLOYEES E1 LEFT JOIN EMPLOYEES E2
ON E2.SALARY > E1.SALARY
GROUP BY E1.EMPLOYEE_ID,E1.SALARY,E1.LAST_NAME
ORDER BY RANK;
