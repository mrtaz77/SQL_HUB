...
-- NON QUALITY CONDITION
SELECT
	E.LAST_NAME,
	COUNT( DISTINCT E2.EMPLOYEE_ID ) HIGH_SAL 
FROM
	EMPLOYEES E LEFT OUTER 
...
FROM
	EMPLOYEES E 
WHERE
	E.SALARY > ( SELECT E2.SALARY FROM EMPLOYEES E2 WHERE E2.LAST_NAME = 'Abel' ) 
ORDER BY
	E.SALARY;
...
FROM
	EMPLOYEES E 
WHERE
	E.SALARY > ( SELECT E2.SALARY FROM EMPLOYEES E2 WHERE E2.EMPLOYEE_ID = 141 ) 
	AND E.JOB_ID = ( SELECT E3.JOB_ID FROM EMPLOYEES E3 WHERE E3.EMPLOYEE_ID = 141 ) 
ORDER BY
	E.SALARY;
